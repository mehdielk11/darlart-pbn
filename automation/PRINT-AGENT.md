...
- `<stamp>_60x75_24_user.pdf` (in `1xxx/`, one per version): the website's **User PDF** (`template.pdf`): finished painting, painted template with numbers, legend with numbers and colors only;
